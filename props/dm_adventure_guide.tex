...
G6 & $\downarrow$I5\,$\uparrow$I2 & the re-arm chain, beside the golem's cage \\
M3 & $\downarrow$I5\,$\uparrow$I8 & opens lower east \\
K2 & $\downarrow$I8\,$\uparrow$I5 & opens lower middle \\
B4 & $\downarrow$E5\,$\uparrow$E2 & backroom endgame control \\
C3 & $\downarrow$E2\,$\uparrow$E5 & backroom endgame control \\
L2 & $\downarrow$E5\,$\uparrow$E8 & opens upper east \\
C8 & $\downarrow$E8\,$\uparrow$E5 & opens upper middle, \textbf{seals the puller in Fritz's corner} --- Fritz can pull it himself: the social path's payoff \\
\bottomrule
\end{tabularx}
