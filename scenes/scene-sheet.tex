...
\section*{DM Notes}
\begin{itemize}
\item On paper the golem is Easy for 8 level-3 PCs --- the map is the difficulty: single-file lanes limit engagement to 1--2 PCs while it deals {\texttildelow}34 avg per round (17 per slam --- can down a level-3 PC in one round)
...
\textbf{Alternate path (improv --- deliberately undesigned):} party defends the cuckoo from Linde's coven (3 green hags) + fey minions over 3 cycles. Coven spells are the real threat; action economy favors the party 8:3.
