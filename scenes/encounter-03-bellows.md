...
### Stirge (x6) — CR 1/8
| AC | HP | Speed | Attack | Damage |
|----|-----|-------|--------|--------|
| 13 | 5 | 10 ft, fly 40 ft | +5 to hit | 6 (1d6+3) piercing + attach |

**Attach:** While attached, cannot attack. Target takes 5 (2d4) necrotic at start of stirge's turn. Any creature within 5 ft can use an action to detach it.

### Swarm of Stirges (x2) — CR 2
| AC | HP | Speed | Attack | Damage |
|----|-----|-------|--------|--------|
| 14 | 36 | 10 ft, fly 40 ft | +5 to hit | 14 (2d10+3) piercing, or 8 (1d10+3) if bloodied |

**Resistances:** Bludgeoning, Piercing, Slashing
**Immunities:** Charmed, Frightened, Grappled, Paralyzed, Petrified, Prone, Restrained, Stunned
**Swarm:** Can occupy another creature's space. Can move through any Tiny opening.
**Grapple:** Medium or smaller targets in the swarm's space are grappled (escape DC 13). Grappled targets take 7 (2d6) necrotic at end of their turn.
...
- **Workbench** (I8-I9, front wall) — the Uhrmacher's bench, set against the back of the great clock face; the delivery manifest lies among the tools (`props/documents/delivery-manifest.html`)
...
- **Modron delivery crate** (I4) — the Gear's original shipping crate, unnaturally square; **the Gear is inside**, re-packed by the Uhrmacher when he disconnected it. The manifest on the bench matches it
...
```
  ...
  G   [B  B] .  ◍  .  .  .  .  .  . [B  B]   ◍ manifold (centered on the G/H-4/5 corner)
  H   [B  B] .  .  ↑  .  .  .  .  ░ [B  B]   [B] bellows, 2×4 each (impassable, climbable, half cover) · ↑ ladder up (right side of H5, a junk square)
  I   ▓  ▓  ░  □  ░  ░  .  W  W  ░  ▓  ▓     W workbench (manifest, I8-I9) · □ crate (Gear inside — DM only, I4) · clock works on the I6-I7 wall
```
...
All stirges dead or driven off. Both bellows worked (ducts blasted clear) and both stubs re-capped — the air channels are restored.
...
- If the encounter is too easy, have a few surviving individual stirges re-emerge from crevices
- If too hard, a swarm at half HP scatters and flees up the pipes
