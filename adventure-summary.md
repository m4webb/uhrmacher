...
- **Timeline (canon):** Wilhelm's era is 1742 — the Gear arrives, the town improves (Kohler's letter, 14. Martius), the wrongness shows (journal, 19. Aprilis), and he disconnects the Gear (journal, 5. Maius) all within that year. **Present day is 1804** — the tower has stood dead for some sixty years. Fits Heinrich: he saw the Tickwichtel as a boy of about ten and is an old man now
